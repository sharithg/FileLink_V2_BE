...
import { IErrorsState, IMessagesState } from "../../actions/types";
...
export class Alerts extends React.PureComponent<IAlertsProps> {
  // static propTypes = {
  //   error: PropTypes.object.isRequired,
  //   message: PropTypes.object.isRequired,
  // };

  componentDidUpdate(prevProps: IAlertsProps) {
